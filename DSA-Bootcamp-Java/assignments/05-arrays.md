...
### Easy
1. [Build Array from Permutation - Done](https://leetcode.com/problems/build-array-from-permutation/)
2. [Concatenation of Array - Done](https://leetcode.com/problems/concatenation-of-array/)
3. [Running Sum of 1d Array - Done](https://leetcode.com/problems/running-sum-of-1d-array/)
4. [Richest Customer Wealth - Done](https://leetcode.com/problems/richest-customer-wealth/)
...
28. [Minimum Cost to Move Chips to The Same Position - Done](https://leetcode.com/problems/minimum-cost-to-move-chips-to-the-same-position/)

### Medium
1. [Spiral Matrix - Done](https://leetcode.com/problems/spiral-matrix/)
2. [Spiral Matrix II - Done](https://leetcode.com/problems/spiral-matrix-ii/)
3. [Spiral Matrix III - Done](https://leetcode.com/problems/spiral-matrix-iii/)
4. [Set Matrix Zeroes - Done](https://leetcode.com/problems/set-matrix-zeroes/)
5. [Product of Array Except Self - Done](https://leetcode.com/problems/product-of-array-except-self/)
6. [Find First and Last Position of Element in Sorted Array - Done](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/)
7. [Jump Game - Done](https://leetcode.com/problems/jump-game/)
8. [Rotate Array - Done](https://leetcode.com/problems/rotate-array/)
9. [Sort Colors - Done](https://leetcode.com/problems/sort-colors/)
10. [House Robber - Done](https://leetcode.com/problems/house-robber/)
